...
archivo_entrada = path + "tp3/src/experimentacion/ejercicio5/exp1/casos.in"
#--constantes
...
archivo_salida = path + "tp3/src/experimentacion/ejercicio5/exp1/corrida.csv"
...
for fila in entrada:
	...
	if len(fila) > 0:
		...
		cant_nodos = int(ultima_fila)
		print "ultima fila: "+str(cant_nodos)
