...
archivo_entrada= path + "tp3/src/experimentacion/ejercicio1/exp3/casos.in"
#--constantes
cant_repeticiones = 8
...
#
#archivo_salida = path + "tp3/src/experimentacion/ejercicio1/exp3/version0.csv"
...
for version in xrange(1,5):
	...
	archivo_salida = path + "tp3/src/experimentacion/ejercicio1/exp3/version"+str(version)+".csv"
