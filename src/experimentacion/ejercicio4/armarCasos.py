...
#--------------------------------------------------------
archivo_salida = path + "tp3/src/experimentacion/ejercicio4/expCalidad/casos.in"
cant_gimnasios = 5;
capacidad_mochila = 5;
maximo_paradas = 500;
...
#--------------------------------------------------------
# archivo_salida = path + "tp3/src/experimentacion/ejercicio4/exp2/casos.in"
# cant_paradas = 100;
# capacidad_mochila = 20;
# maximo_gimnasios = 200;
...
#--------------------------------------------------------
archivo_salida = path + "tp3/src/experimentacion/ejercicio4/exp3/casos.in"
cant_paradas = 5;
cant_gimnasios = 6;
maximo_capacidad = 500;
