...
archivo_entrada = path + "tp3/src/experimentacion/ejercicio4/expCalidadMochilas/casos.in"
#--constantes
cant_repeticiones = 1
...
archivo_salida = path + "tp3/src/experimentacion/ejercicio4/expCalidadMochilas/corrida.csv"
...
for fila in entrada:
	...
	if len(fila) > 0:
		...
		for j in xrange(0, cant_repeticiones):
			...
			res = abs(float(aux1[3]) - float(aux2[3]))
