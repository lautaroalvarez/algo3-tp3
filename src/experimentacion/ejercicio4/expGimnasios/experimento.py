...
archivo_entrada = path + "tp3/src/experimentacion/ejercicio4/exp1/casos.in"
#--constantes
cant_repeticiones = 1
...
archivo_salida = path + "tp3/src/experimentacion/ejercicio4/exp1/corrida.csv"

commands.getstatusoutput("echo 'Cantidad de gimnasios, Tiempo' >> "+archivo_salida)
